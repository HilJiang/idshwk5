...
def initData(filename):
	with open(filename) as f:
		for line in f:
			...
			num=0
			entro=0     #entropy
			result={}   #times of every character appearing
			frequency={}#frequency of every character appearing
			for i in name:
...
def main():
	...
	for line in file1:
		...
		num_test=0
		entro_test=0     #entropy
		result_test={}   #times of every character appearing
		frequency_test={}#frequency of every character appearing
		for i in name_test:
